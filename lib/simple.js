...
/**
 * Este fork exporta TODO dentro de default
 */
const {
  getContentType,
  jidDecode,
...
const makeWASocketBase = baileys?.default?.makeWASocket

if (typeof makeWASocketBase !== 'function') {
  throw new Error(
    '[simple.js] makeWASocket no encontrado. Fork de Baileys incompatible.'
  )
}
